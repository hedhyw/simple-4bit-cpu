...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot calc xil_defaultlib.calc xil_defaultlib.glbl -log elaborate.log
}
