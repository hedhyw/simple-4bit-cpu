...
module ctrl_fsm_test;
    ...
    begin
        ...
        #30 begin // case 6 - second S4_REG_W
            #10 clk = ~clk;
            #10 clk = ~clk;
            #50 if (pc_inc_en == 1'b0 &&
                mem_en == 1'b0 &&
        ...
        #30 begin // case 7 - second S6_PC_INC
            #10 clk = ~clk;
            #10 clk = ~clk;
        ...
        #30 begin // case 8 - second S7_DONE
            #10 clk = ~clk;
            #10 clk = ~clk;
            #50 if (pc_inc_en == 1'b0 &&
                mem_en == 1'b0 &&
