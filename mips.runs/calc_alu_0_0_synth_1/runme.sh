...
HD_PWD='/home/hedhyw/Development/GraduateWork/MIPS/mips.runs/calc_alu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_alu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_alu_0_0.tcl
