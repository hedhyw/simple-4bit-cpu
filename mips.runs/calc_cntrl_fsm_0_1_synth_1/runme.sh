...
HD_PWD='/home/hedhyw/Development/GraduateWork/MIPS/mips.runs/calc_cntrl_fsm_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_cntrl_fsm_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_cntrl_fsm_0_1.tcl
